...
public class ElectronicListFragment extends Fragment implements ItemAdapter.Listener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) inflater.inflate(R.layout.fragment_electronic_list,container,false);

        LetBuyDatabaseHelper helper = new LetBuyDatabaseHelper(getActivity());

        try{
            SQLiteDatabase database = helper.getReadableDatabase();
            Cursor cursor = database.query("ITEM_DB",new String[]{"_id","SELLER","NAME","TYPE","DESCRIPTION","PRICE","IMAGEID"},"TYPE = ?",new String[]{"Electronic"},null,null,null);
    ...
    public void onItemClicked(int position) {
        listener.spesificItemClicked(position,"Electronic");
    }
