...
public class ItemListFragment extends Fragment implements ItemAdapter.Listener{
    private FragmentListener fragmentListener;

    public static interface FragmentListener {
        void handleItemClickedInMainActivity(int itemId);
    }
    @Override
    ...
    public void onItemClicked(int position) {
        fragmentListener.handleItemClickedInMainActivity(position);
    }
